...
// ************************************************************************************************
inline PandaFramework* ShowBase::get_panda_framework(void) const
{
	return panda_framework_;
}

inline WindowFramework* ShowBase::get_window_framework(void) const
{
	return window_framework_;
}
