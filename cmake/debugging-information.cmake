    ...
    foreach(config ${ARG_CONFIGURATIONS})
        ...
        if(MSVC)
            ...
            if(private_debinfo_postfix)
                set(DEBINFO_PATH "${LIBRARY_OUTPUT_DIRECTORY}/${PREFIX}${OUTPUT_NAME}${POSTFIX}${private_debinfo_postfix}.pdb")
                set(DEBINFO_STRIP_PATH "${LIBRARY_OUTPUT_DIRECTORY}/${PREFIX}${OUTPUT_NAME}${POSTFIX}.pdb")
                ...
                set(DEBINFO_PATH "${LIBRARY_OUTPUT_DIRECTORY}/${PREFIX}${OUTPUT_NAME}${POSTFIX}.pdb")
                set_target_properties(${ARG_TARGET} PROPERTIES DEBINFO_PATH_${config_upper} "${DEBINFO_PATH}")
            endif()
        else()
            if(strip_postfix)
