...
# install_debugging_information(target)
#
# Install debugging information files for the target.
function(install_debugging_information target)
    foreach(config "Debug" "RelWithDebInfo")
        if(MSVC)
            string(TOUPPER ${config} config_upper)
            ...
            install(FILES "${DEBINFO_PATH}" DESTINATION "bin" CONFIGURATIONS ${config})
            if(DEBINFO_STRIP_PATH)
                install(FILES "${DEBINFO_STRIP_PATH}" DESTINATION "bin" CONFIGURATIONS ${config})
            endif()
        endif()
    endforeach()
endfunction()
